...
export const students: Student[] = [
  { studentId: 'stu1', stuCode: 'S001', prefixTh: 'ด.ช.', firstNameTh: 'สมชาย', lastNameTh: 'ใจดี', level: 'ป.6', room: '1', homeroomEmail: 'teacher.a@school.ac.th', status: 'ACTIVE', admitYearBe: 2562 },
  { studentId: 'stu2', stuCode: 'S002', prefixTh: 'ด.ญ.', firstNameTh: 'สมหญิง', lastNameTh: 'เรียนเก่ง', level: 'ป.6', room: '1', homeroomEmail: 'teacher.a@school.ac.th', status: 'ACTIVE', admitYearBe: 2562 },
  { studentId: 'stu3', stuCode: 'S003', prefixTh: 'ด.ช.', firstNameTh: 'มานะ', lastNameTh: 'พากเพียร', level: 'ม.1', room: '2', homeroomEmail: 'teacher.b@school.ac.th', status: 'ACTIVE', admitYearBe: 2568 },
  { studentId: 'stu4', stuCode: 'S004', prefixTh: 'ด.ญ.', firstNameTh: 'ปิติ', lastNameTh: 'ยินดี', level: 'ม.1', room: '2', homeroomEmail: 'teacher.b@school.ac.th', status: 'ACTIVE', admitYearBe: 2568 },
  { studentId: 'stu5', stuCode: 'S005', prefixTh: 'ด.ช.', firstNameTh: 'วีระ', lastNameTh: 'กล้าหาญ', level: 'ม.1', room: '2', homeroomEmail: 'teacher.b@school.ac.th', status: 'ACTIVE', admitYearBe: 2568 },
];
