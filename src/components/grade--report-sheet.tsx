        ...
        >
            ...
            <div className="mt-2">
                <div className="flex">
                    ...
                    <div className="w-1/2 flex flex-col justify-end items-center pl-2">
                        <div className="w-full space-y-4 text-center" style={{ fontSize: '16px', fontFamily: '"TH Sarabun New", sans-serif' }}>
                                ...
                                {homeroomTeachers && homeroomTeachers.length > 0 && (
                                    <>
                                        {homeroomTeachers.map((teacher, index) => (
                                            <p key={index} className="mt-0 mb-0">........................................................</p>
                                        ))}
                                         <p className="mt-0 mb-0">({homeroomTeachers.join(' และ ')})</p>
                                        <p>ครูประจำชั้น</p>
                                    </>
                                )}
                            </div>
                            <div>
                             ...
                             <div className="relative h-24">
                                ...
                                <Image src="/director-signature.png" alt="Director's Signature" width={120} height={40} style={{ objectFit: 'contain' }} />
                                </div>
