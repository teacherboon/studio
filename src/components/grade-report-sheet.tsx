                            ...
                            <div>
                             ...
                             <div className="relative h-24">
                                <div className="absolute bottom-6 inset-x-0 flex justify-center">
                                    <Image src="https://storage.googleapis.com/gweb-aip-dev.appspot.com/public/project_images/66a014a45a3d463b827e8a9f/1721768132442.png" alt="Director's Signature" width={240} height={80} style={{ objectFit: 'contain' }} />
                                </div>
